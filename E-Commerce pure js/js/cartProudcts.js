...
function drawProudectCart(products) {
  ...
  let y = products.map((item) => {
    ...
    return `
        <div id="product-${item.id}" class="product-item col-6 col-xl-4 mb-4">
        <div  class="card border border-info">
          <div class="row">
            <div class="col-md-4">
              <img class="product-item-img card-img-top ml-3 mt-4" src="${item.imageURL}" style="width:140px; height=:130px" alt="Card image">
            </div>
            <div class="col-md-8">
      ...
      slideContent += `
        <div class="col-4">
          <div class="card border border-info pt-3">
            <img class="product-item-img card-img-top m-auto" src="${item.imageURL}" alt="Card image" style="width:80%; height: 100px;">
            <div class="row">
